...
*  history:   0.01 created by chenxd ，RT LM一期
*  
*             0.02 移植到SS项目,支持doxygen
*             
...
#define SS_ERROR_IPC_QUERY_STATE                    0x02000005  //  查询SS状态失败
#define SS_ERROR_SERVICE_NOT_RUNNING                0x02000006  //  SS未运行
...
#define ERROR_LM_SVC_DEBUGGED                       0x24000008  //  发现被调试
...
#define SS_ERROR_FIRM_LIC_ALREADY_ENABLED           0x22000028  // 许可原已经有效
