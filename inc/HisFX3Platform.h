...
namespace RBOXAPI
{
	...
	*/
	...
	\param[in] addInfoBytes; 图像数据附加信息大小， 单位: Byte；正数表示在帧头位置， 负数表示在帧尾位置
	\param[in] cam 模组编号
	\return 0:成功  非0:失败
	...
	*/
	...
	\param[in] vsHigh  VS 同步信号设置。   true: 高电平有效；   false: 低电平有效
	\param[in] ps  采集同步信号相移  0:不相移;  1: 90度;  2: 180度;  3: 270度; 
	\param[in] cam 模组编号
	\return 0:成功  非0:失败 请参考_HisFX3Platform_ErrorCode
	\sa _HisFX3Platform_ErrorCode
	*/
